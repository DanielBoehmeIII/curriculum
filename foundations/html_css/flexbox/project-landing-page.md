...
- There has been some criticism of TOP for waiting to cover media queries. If you'd like to optimize your landing page for other devices, feel free to skip to our future lesson [Media Queries](https://www.theodinproject.com/lessons/node-path-advanced-html-and-css-media-queries) or watch this video [Odin Landing Page project discussion](https://perpetual.education/stories/odin-landing-page-project-discussion/)
